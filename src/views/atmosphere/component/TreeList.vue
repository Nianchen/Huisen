...
                  <img v-else :src="images[0]"/>
            ...
            <!-- <span v-if="checked===1">
              <el-button  type="text" size="mini" @click.stop="() => append(data)" v-hasPermi="['weather:weatherComponent:edit']">
                 <i class="el-icon-plus"></i>
              </el-button>
              <el-button class="buttons" type="text" size="mini" @click.stop="() => update(node, data)" v-hasPermi="['weather:weatherComponent:edit']">
                  <i class="el-icon-edit"></i>
              </el-button>
              <el-button type="text" size="mini" @click.stop="() => remove(node, data)" v-hasPermi="['weather:weatherComponent:edit']">
  ...
  methods: {
    ...
    getGroupTree() {
      groupTree().then(response => {
        ...
        this.$bus.$emit('atmTreeData',this.groupTreeData)
      });
    },
    /** 查询部门下拉树结构 */
    getDeptTree() {
    ...
    remove(node, data) {
      ...
      this.$confirm(
        ...
        delWeatherGroup(data.id).then(response => {
