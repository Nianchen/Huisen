<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="灯头号" prop="no">
        <el-input
      ...
      <el-form-item label="总电量" prop="zdl">
        <el-input
      ...
      <el-form-item label="理论电量" prop="lldl">
        <el-input
    ...
    <el-table v-loading="loading" :data="capList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="灯头号" align="center" prop="no" />
      ...
      <el-table-column label="总电量" align="center" prop="zdl" />
      <el-table-column label="理论电量" align="center" prop="lldl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="总电量" prop="zdl">
          <el-input v-model="form.zdl" placeholder="请输入总电量" />
        </el-form-item>
        <el-form-item label="理论电量" prop="lldl">
          <el-input v-model="form.lldl" placeholder="请输入理论电量" />
        </el-form-item>
        <el-form-item label="上报时间" prop="reportTime">
          <el-date-picker clearable size="small"
...
<script>
import { listCap, getCap, delCap, addCap, updateCap } from "@/api/lamp/cap";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listCap(this.queryParams).then(response => {
        this.capList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateCap(this.form).then(response => {
              this.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addCap(this.form).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除灯头编号为"' + ids + '"的数据项?', "警告", {
